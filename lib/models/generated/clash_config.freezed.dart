...
/// @nodoc
abstract class _$$_ProxyGroupCopyWith<$Res>
    implements $ProxyGroupCopyWith<$Res> {
  factory _$$_ProxyGroupCopyWith(
          _$_ProxyGroup value, $Res Function(_$_ProxyGroup) then) =
      __$$_ProxyGroupCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String name,
...
/// @nodoc
class __$$_ProxyGroupCopyWithImpl<$Res>
    extends _$ProxyGroupCopyWithImpl<$Res, _$_ProxyGroup>
    implements _$$_ProxyGroupCopyWith<$Res> {
  __$$_ProxyGroupCopyWithImpl(
      _$_ProxyGroup _value, $Res Function(_$_ProxyGroup) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_ProxyGroup implements _ProxyGroup {
  const _$_ProxyGroup(
      {required this.name,
  ...
  factory _$_ProxyGroup.fromJson(Map<String, dynamic> json) =>
      _$$_ProxyGroupFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_ProxyGroupCopyWith<_$_ProxyGroup> get copyWith =>
      __$$_ProxyGroupCopyWithImpl<_$_ProxyGroup>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ProxyGroupToJson(
      this,
    );
  }
}
...
abstract class _ProxyGroup implements ProxyGroup {
  const factory _ProxyGroup(
      ...
      @JsonKey(name: 'expected-status')
          final dynamic expectedStatus,
      final bool? hidden,
      final String? icon}) = _$_ProxyGroup;

  factory _ProxyGroup.fromJson(Map<String, dynamic> json) =
      _$_ProxyGroup.fromJson;
...
/// @nodoc
abstract class _$$_RuleProviderCopyWith<$Res>
    implements $RuleProviderCopyWith<$Res> {
  factory _$$_RuleProviderCopyWith(
          _$_RuleProvider value, $Res Function(_$_RuleProvider) then) =
      __$$_RuleProviderCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String name});
}
...
/// @nodoc
class __$$_RuleProviderCopyWithImpl<$Res>
    extends _$RuleProviderCopyWithImpl<$Res, _$_RuleProvider>
    implements _$$_RuleProviderCopyWith<$Res> {
  __$$_RuleProviderCopyWithImpl(
      _$_RuleProvider _value, $Res Function(_$_RuleProvider) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_RuleProvider implements _RuleProvider {
  const _$_RuleProvider({required this.name});

  factory _$_RuleProvider.fromJson(Map<String, dynamic> json) =>
      _$$_RuleProviderFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_RuleProviderCopyWith<_$_RuleProvider> get copyWith =>
      __$$_RuleProviderCopyWithImpl<_$_RuleProvider>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_RuleProviderToJson(
      this,
    );
  }
}
...
abstract class _RuleProvider implements RuleProvider {
  const factory _RuleProvider({required final String name}) = _$_RuleProvider;

  factory _RuleProvider.fromJson(Map<String, dynamic> json) =
      _$_RuleProvider.fromJson;
...
/// @nodoc
abstract class _$$_SnifferCopyWith<$Res> implements $SnifferCopyWith<$Res> {
  factory _$$_SnifferCopyWith(
          _$_Sniffer value, $Res Function(_$_Sniffer) then) =
      __$$_SnifferCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool enable,
...
/// @nodoc
class __$$_SnifferCopyWithImpl<$Res>
    extends _$SnifferCopyWithImpl<$Res, _$_Sniffer>
    implements _$$_SnifferCopyWith<$Res> {
  __$$_SnifferCopyWithImpl(_$_Sniffer _value, $Res Function(_$_Sniffer) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_Sniffer implements _Sniffer {
  const _$_Sniffer(
      {this.enable = false,
      @JsonKey(name: 'override-destination')
          this.overrideDest = true,
      final List<String> sniffing = const [],
      @JsonKey(name: 'force-domain')
          final List<String> forceDomain = const [],
      @JsonKey(name: 'skip-src-address')
          final List<String> skipSrcAddress = const [],
      @JsonKey(name: 'skip-dst-address')
          final List<String> skipDstAddress = const [],
      @JsonKey(name: 'skip-domain')
          final List<String> skipDomain = const [],
      @JsonKey(name: 'port-whitelist')
          final List<String> port = const [],
      @JsonKey(name: 'force-dns-mapping')
          this.forceDnsMapping = true,
      @JsonKey(name: 'parse-pure-ip')
          this.parsePureIp = true,
  ...
  factory _$_Sniffer.fromJson(Map<String, dynamic> json) =>
      _$$_SnifferFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SnifferCopyWith<_$_Sniffer> get copyWith =>
      __$$_SnifferCopyWithImpl<_$_Sniffer>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SnifferToJson(
      this,
    );
  }
}
...
abstract class _Sniffer implements Sniffer {
  const factory _Sniffer(
      ...
      final Map<String, SnifferConfig> sniff}) = _$_Sniffer;

  factory _Sniffer.fromJson(Map<String, dynamic> json) = _$_Sniffer.fromJson;
...
/// @nodoc
abstract class _$$_SnifferConfigCopyWith<$Res>
    implements $SnifferConfigCopyWith<$Res> {
  factory _$$_SnifferConfigCopyWith(
          _$_SnifferConfig value, $Res Function(_$_SnifferConfig) then) =
      __$$_SnifferConfigCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(fromJson: _formJsonPorts) List<String> ports,
...
/// @nodoc
class __$$_SnifferConfigCopyWithImpl<$Res>
    extends _$SnifferConfigCopyWithImpl<$Res, _$_SnifferConfig>
    implements _$$_SnifferConfigCopyWith<$Res> {
  __$$_SnifferConfigCopyWithImpl(
      _$_SnifferConfig _value, $Res Function(_$_SnifferConfig) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_SnifferConfig implements _SnifferConfig {
  const _$_SnifferConfig(
      {@JsonKey(fromJson: _formJsonPorts) final List<String> ports = const [],
      @JsonKey(name: 'override-destination') this.overrideDest})
      : _ports = ports;

  factory _$_SnifferConfig.fromJson(Map<String, dynamic> json) =>
      _$$_SnifferConfigFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SnifferConfigCopyWith<_$_SnifferConfig> get copyWith =>
      __$$_SnifferConfigCopyWithImpl<_$_SnifferConfig>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SnifferConfigToJson(
      this,
    );
  }
}
...
/// @nodoc
abstract class _$$_TunCopyWith<$Res> implements $TunCopyWith<$Res> {
  factory _$$_TunCopyWith(_$_Tun value, $Res Function(_$_Tun) then) =
      __$$_TunCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool enable,
...
/// @nodoc
class __$$_TunCopyWithImpl<$Res> extends _$TunCopyWithImpl<$Res, _$_Tun>
    implements _$$_TunCopyWith<$Res> {
  __$$_TunCopyWithImpl(_$_Tun _value, $Res Function(_$_Tun) _then)
      : super(_value, _then);
...
class _$_Tun implements _Tun {
  ...
  factory _$_Tun.fromJson(Map<String, dynamic> json) => _$$_TunFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_TunCopyWith<_$_Tun> get copyWith =>
      __$$_TunCopyWithImpl<_$_Tun>(this, _$identity);
...
abstract class _Tun implements Tun {
  ...
  factory _Tun.fromJson(Map<String, dynamic> json) = _$_Tun.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$$_TunCopyWith<_$_Tun> get copyWith => throw _privateConstructorUsedError;
}
...
/// @nodoc
abstract class _$$_FallbackFilterCopyWith<$Res>
    implements $FallbackFilterCopyWith<$Res> {
  factory _$$_FallbackFilterCopyWith(
          _$_FallbackFilter value, $Res Function(_$_FallbackFilter) then) =
      __$$_FallbackFilterCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool geoip,
...
/// @nodoc
class __$$_FallbackFilterCopyWithImpl<$Res>
    extends _$FallbackFilterCopyWithImpl<$Res, _$_FallbackFilter>
    implements _$$_FallbackFilterCopyWith<$Res> {
  __$$_FallbackFilterCopyWithImpl(
      _$_FallbackFilter _value, $Res Function(_$_FallbackFilter) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_FallbackFilter(
      geoip: null == geoip
          ? _value.geoip
          : geoip // ignore: cast_nullable_to_non_nullable
              as bool,
...
/// @nodoc
@JsonSerializable()
class _$_FallbackFilter implements _FallbackFilter {
  const _$_FallbackFilter(
      {this.geoip = true,
  ...
  factory _$_FallbackFilter.fromJson(Map<String, dynamic> json) =>
      _$$_FallbackFilterFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_FallbackFilterCopyWith<_$_FallbackFilter> get copyWith =>
      __$$_FallbackFilterCopyWithImpl<_$_FallbackFilter>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_FallbackFilterToJson(
      this,
    );
  }
}
...
abstract class _FallbackFilter implements FallbackFilter {
  const factory _FallbackFilter(
      ...
      final List<String> domain}) = _$_FallbackFilter;

  factory _FallbackFilter.fromJson(Map<String, dynamic> json) =
      _$_FallbackFilter.fromJson;
...
/// @nodoc
abstract class _$$_DnsCopyWith<$Res> implements $DnsCopyWith<$Res> {
  factory _$$_DnsCopyWith(_$_Dns value, $Res Function(_$_Dns) then) =
      __$$_DnsCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool enable,
...
/// @nodoc
class __$$_DnsCopyWithImpl<$Res> extends _$DnsCopyWithImpl<$Res, _$_Dns>
    implements _$$_DnsCopyWith<$Res> {
  __$$_DnsCopyWithImpl(_$_Dns _value, $Res Function(_$_Dns) _then)
      : super(_value, _then);
...
class _$_Dns implements _Dns {
  const _$_Dns(
      ...
      @JsonKey(name: 'fake-ip-filter')
          final List<String> fakeIpFilter = const [
        '*.lan',
  ...
  factory _$_Dns.fromJson(Map<String, dynamic> json) => _$$_DnsFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_DnsCopyWith<_$_Dns> get copyWith =>
      __$$_DnsCopyWithImpl<_$_Dns>(this, _$identity);
...
abstract class _Dns implements Dns {
  const factory _Dns(
      ...
      @JsonKey(name: 'fallback-filter')
          final FallbackFilter fallbackFilter}) = _$_Dns;

  factory _Dns.fromJson(Map<String, dynamic> json) = _$_Dns.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$$_DnsCopyWith<_$_Dns> get copyWith => throw _privateConstructorUsedError;
}
...
/// @nodoc
abstract class _$$_GeoXUrlCopyWith<$Res> implements $GeoXUrlCopyWith<$Res> {
  factory _$$_GeoXUrlCopyWith(
          _$_GeoXUrl value, $Res Function(_$_GeoXUrl) then) =
      __$$_GeoXUrlCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String mmdb, String asn, String geoip, String geosite});
}
...
/// @nodoc
class __$$_GeoXUrlCopyWithImpl<$Res>
    extends _$GeoXUrlCopyWithImpl<$Res, _$_GeoXUrl>
    implements _$$_GeoXUrlCopyWith<$Res> {
  __$$_GeoXUrlCopyWithImpl(_$_GeoXUrl _value, $Res Function(_$_GeoXUrl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_GeoXUrl implements _GeoXUrl {
  const _$_GeoXUrl(
      {this.mmdb =
  ...
  factory _$_GeoXUrl.fromJson(Map<String, dynamic> json) =>
      _$$_GeoXUrlFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_GeoXUrlCopyWith<_$_GeoXUrl> get copyWith =>
      __$$_GeoXUrlCopyWithImpl<_$_GeoXUrl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_GeoXUrlToJson(
      this,
    );
  }
}
...
abstract class _GeoXUrl implements GeoXUrl {
  const factory _GeoXUrl(
      ...
      final String asn,
      final String geoip,
      final String geosite}) = _$_GeoXUrl;

  factory _GeoXUrl.fromJson(Map<String, dynamic> json) = _$_GeoXUrl.fromJson;
...
/// @nodoc
abstract class _$$_ParsedRuleCopyWith<$Res>
    implements $ParsedRuleCopyWith<$Res> {
  factory _$$_ParsedRuleCopyWith(
          _$_ParsedRule value, $Res Function(_$_ParsedRule) then) =
      __$$_ParsedRuleCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {RuleAction ruleAction,
...
/// @nodoc
class __$$_ParsedRuleCopyWithImpl<$Res>
    extends _$ParsedRuleCopyWithImpl<$Res, _$_ParsedRule>
    implements _$$_ParsedRuleCopyWith<$Res> {
  __$$_ParsedRuleCopyWithImpl(
      _$_ParsedRule _value, $Res Function(_$_ParsedRule) _then)
      : super(_value, _then);
...
class _$_ParsedRule implements _ParsedRule {
  const _$_ParsedRule(
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_ParsedRuleCopyWith<_$_ParsedRule> get copyWith =>
      __$$_ParsedRuleCopyWithImpl<_$_ParsedRule>(this, _$identity);
}
...
abstract class $RuleCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String value, String? order});
}
...
class _$_Rule implements _Rule {
  const _$_Rule({required this.id, required this.value, this.order});
...
/// @nodoc
abstract class _$$_SubRuleCopyWith<$Res> implements $SubRuleCopyWith<$Res> {
  factory _$$_SubRuleCopyWith(
          _$_SubRule value, $Res Function(_$_SubRule) then) =
      __$$_SubRuleCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String name});
}
...
/// @nodoc
class __$$_SubRuleCopyWithImpl<$Res>
    extends _$SubRuleCopyWithImpl<$Res, _$_SubRule>
    implements _$$_SubRuleCopyWith<$Res> {
  __$$_SubRuleCopyWithImpl(_$_SubRule _value, $Res Function(_$_SubRule) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_SubRule implements _SubRule {
  const _$_SubRule({required this.name});

  factory _$_SubRule.fromJson(Map<String, dynamic> json) =>
      _$$_SubRuleFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SubRuleCopyWith<_$_SubRule> get copyWith =>
      __$$_SubRuleCopyWithImpl<_$_SubRule>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SubRuleToJson(
      this,
    );
  }
}
...
abstract class _SubRule implements SubRule {
  const factory _SubRule({required final String name}) = _$_SubRule;

  factory _SubRule.fromJson(Map<String, dynamic> json) = _$_SubRule.fromJson;
...
/// @nodoc
abstract class _$$_ClashConfigSnippetCopyWith<$Res>
    implements $ClashConfigSnippetCopyWith<$Res> {
  factory _$$_ClashConfigSnippetCopyWith(_$_ClashConfigSnippet value,
          $Res Function(_$_ClashConfigSnippet) then) =
      __$$_ClashConfigSnippetCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'proxy-groups')
...
/// @nodoc
class __$$_ClashConfigSnippetCopyWithImpl<$Res>
    extends _$ClashConfigSnippetCopyWithImpl<$Res, _$_ClashConfigSnippet>
    implements _$$_ClashConfigSnippetCopyWith<$Res> {
  __$$_ClashConfigSnippetCopyWithImpl(
      _$_ClashConfigSnippet _value, $Res Function(_$_ClashConfigSnippet) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_ClashConfigSnippet(
      proxyGroups: null == proxyGroups
          ? _value._proxyGroups
          : proxyGroups // ignore: cast_nullable_to_non_nullable
              as List<ProxyGroup>,
...
/// @nodoc
@JsonSerializable()
class _$_ClashConfigSnippet implements _ClashConfigSnippet {
  const _$_ClashConfigSnippet(
      {@JsonKey(name: 'proxy-groups')
  ...
  factory _$_ClashConfigSnippet.fromJson(Map<String, dynamic> json) =>
      _$$_ClashConfigSnippetFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_ClashConfigSnippet &&
            const DeepCollectionEquality()
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_ClashConfigSnippetCopyWith<_$_ClashConfigSnippet> get copyWith =>
      __$$_ClashConfigSnippetCopyWithImpl<_$_ClashConfigSnippet>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ClashConfigSnippetToJson(
      this,
    );
  }
}
...
abstract class _ClashConfigSnippet implements ClashConfigSnippet {
  const factory _ClashConfigSnippet(
      ...
      @JsonKey(name: 'sub-rules', fromJson: _genSubRules)
          final List<SubRule> subRules}) = _$_ClashConfigSnippet;

  factory _ClashConfigSnippet.fromJson(Map<String, dynamic> json) =
      _$_ClashConfigSnippet.fromJson;
...
/// @nodoc
abstract class _$$_ClashConfigCopyWith<$Res>
    implements $ClashConfigCopyWith<$Res> {
  factory _$$_ClashConfigCopyWith(
          _$_ClashConfig value, $Res Function(_$_ClashConfig) then) =
      __$$_ClashConfigCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'mixed-port')
...
/// @nodoc
class __$$_ClashConfigCopyWithImpl<$Res>
    extends _$ClashConfigCopyWithImpl<$Res, _$_ClashConfig>
    implements _$$_ClashConfigCopyWith<$Res> {
  __$$_ClashConfigCopyWithImpl(
      _$_ClashConfig _value, $Res Function(_$_ClashConfig) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_ClashConfig implements _ClashConfig {
  const _$_ClashConfig(
      {@JsonKey(name: 'mixed-port')
  ...
  factory _$_ClashConfig.fromJson(Map<String, dynamic> json) =>
      _$$_ClashConfigFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_ClashConfigCopyWith<_$_ClashConfig> get copyWith =>
      __$$_ClashConfigCopyWithImpl<_$_ClashConfig>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ClashConfigToJson(
      this,
    );
  }
}
...
abstract class _ClashConfig implements ClashConfig {
  const factory _ClashConfig(
      ...
      @JsonKey(name: 'external-controller')
          final ExternalControllerStatus externalController,
      final Map<String, String> hosts}) = _$_ClashConfig;

  factory _ClashConfig.fromJson(Map<String, dynamic> json) =
      _$_ClashConfig.fromJson;
